...
export const strings: Record<Lang, CheckerStrings> = {
  en: {
    ...
    checklistTitle: 'Your checklist', cta: 'Have a lawyer confirm your route', ctaHref: '/en/contact/?origen=citizenship-checker', ctaNote: 'Free evaluation · reply within 24 working hours', restart: 'Start again',
  ...
  es: {
    ...
    checklistTitle: 'Su lista de tareas', cta: 'Que un abogado confirme su vía', ctaHref: '/es/contacto/?origen=verificador-nacionalidad', ctaNote: 'Evaluación gratuita · respuesta en 24 h laborables', restart: 'Empezar de nuevo',
  ...
  fr: {
    ...
    checklistTitle: 'Votre liste', cta: 'Faire confirmer votre voie par un avocat', ctaHref: '/fr/contact/?origen=verificateur-nationalite', ctaNote: 'Évaluation gratuite · réponse sous 24 h ouvrées', restart: 'Recommencer',
