...
export const messages: Record<Lang, Record<MessageCode, string>> = {
  es: {
    ...
    BLOCKER_INCOME_LOW: 'Tus ingresos están por debajo del requisito mínimo (aprox. 2.400€/mes brutos en 2026).',
    WARNING_INCOME_BORDERLINE: 'Tus ingresos están en un rango límite. El mínimo es de aproximadamente 2.400€/mes.',
  ...
  en: {
    ...
    BLOCKER_INCOME_LOW: 'Your income is below the minimum requirement (approx. €2,400/month gross in 2026).',
    WARNING_INCOME_BORDERLINE: 'Your income is in a borderline range. The minimum is approximately €2,400/month.',
  ...
  fr: {
    ...
    BLOCKER_INCOME_LOW: 'Vos revenus sont inférieurs à l\'exigence minimale (environ 2 400 €/mois brut en 2026).',
    WARNING_INCOME_BORDERLINE: 'Vos revenus se situent dans une fourchette limite. Le minimum est d\'environ 2 400 €/mois.',
